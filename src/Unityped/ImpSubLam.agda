----------------------------------------------------------------------------
-- A unityped category with families with implicit substitutions. It is an
...
r∘-asso : ∀ {m n k} (ρ : Ren m n) (σ : Sub k m) t
          → t [ ρ r∘ σ ] ≡ (t / ρ) [ σ ]
...
congSub-s : ∀ {m n} {t : Tm n} {σ σ' : Sub m n}
            → σ ≈βη σ'
            → t [ σ ] ~βη t [ σ' ]
congSub-s {σ = []} {[]}     ⋄            = refl~βη
...
cong-sub : ∀ {m n} {t t' : Tm n} {σ σ' : Sub m n}
           → t ~βη t'
           → σ ≈βη σ'
           → t [ σ ] ~βη t' [ σ' ]
