...
-------------------------------------------------------------------------------
module SimpTyped.Old.Isomorphism where

open import SimpTyped.Old.ExpSub.ScwfExpSub renaming (Tm to Tm-cwf ; Sub to Sub-cwf)
...
open import SimpTyped.Old.ImpSub.Properties hiding (id₀)
open import SimpTyped.Old.Context
