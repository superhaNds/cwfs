...
-------------------------------------------------------------------
module Unityped.ExpSub.Projection where
...
-------------------------------------------------------------------
-- Sequences of Fin elements to build the explicit p
...
module Fins where
  ...
  tabulate-∘ : ∀ {n m k} (f : Fin m → Fin k) (g : Fin n → Fin m)
...
module PProof where
  ...
  open import Unityped.ExpSub.UcwfExpSub renaming (Tm to Tm-cwf)
